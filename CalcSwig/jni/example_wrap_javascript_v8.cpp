...
v8::Handle<v8::Value> _wrap_returnDoubleArray2(const v8::Arguments &args) {
  v8::HandleScope scope;
  v8::Handle<v8::Value> jsresult;
  double *result = 0 ;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_returnDoubleArray2.");  
  
  result = (double *)returnDoubleArray2();
...
v8::Handle<v8::Value> _wrap_returnStringArray2(const v8::Arguments &args) {
  v8::HandleScope scope;
  v8::Handle<v8::Value> jsresult;
  char **result = 0 ;
  
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_returnStringArray2.");  
  
  result = (char **)returnStringArray2();
...
//extern "C" {
  void example_initialize(v8::Handle<v8::Object> global_obj)
  {
    ...
    SWIGV8_AddStaticFunction(example_obj, "returnDoubleArray2", _wrap_returnDoubleArray2);
    SWIGV8_AddStaticFunction(example_obj, "returnStringArray2", _wrap_returnStringArray2);
